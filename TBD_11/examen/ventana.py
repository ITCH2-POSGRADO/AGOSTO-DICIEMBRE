...
class Ventana(Frame):
    ...
    def create_widgets(self):
        ...
        self.txtCapital=Entry(frame2)from tkinter import *
from tkinter import ttk
...
class Ventana(Frame):
    ...
    def create_widgets(self):
        ...
        self.txtISO3=Entry(frame2)
        self.txtISO3.place(x=3,y=25,width=50, height=30) 

        lbl2 = Label(frame2,text="Genero: ")
        lbl2.place(x=3,y=55)

        self.txtName=Entry(frame2)
        self.txtName.place(x=3,y=75,width=100, height=30)

        lbl3 = Label(frame2,text="Duracion: ")
        lbl3.place(x=3,y=105)

        self.txtCapital=Entry(frame2)
        self.txtCapital.place(x=3,y=125,width=100, height=30)

        lbl4 = Label(frame2,text="Codigo director: ")
        lbl4.place(x=3,y=155)

        self.txtCurrency=Entry(frame2)
        self.txtCurrency.place(x=3,y=175,width=50, height=30)
