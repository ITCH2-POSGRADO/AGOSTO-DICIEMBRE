...
class Ventana(Frame):
    ...
    def create_widgets(self):
        ...
        lbl1 = Label(frame2,text="Pelicula:")
        lbl1.place(x=3,y=5, width=100)

        self.txtISO3=Entry(frame2)
        self.txtISO3.place(x=3,y=25,width=100, height=20) 

        lbl2 = Label(frame2,text="Genero:")
        lbl2.place(x=3,y=55, width=100)

        self.cbgenero = ttk.Combobox(frame2, values=['HOLA', 'xd'])
        self.cbgenero.place(x=3,y=75,width=100, height=20)

        lbl3 = Label(frame2,text="Duracion:")
        lbl3.place(x=3,y=105, width=100)

        self.txtCapital=Entry(frame2)
        self.txtCapital.place(x=3,y=125,width=100, height=20)

        lbl4 = Label(frame2,text="Nombre director: ")
        lbl4.place(x=3,y=155, width=100)
        ...
        self.grid.heading("col1", text="Pelicula", anchor=CENTER)
        self.grid.heading("col2", text="Genero", anchor=CENTER)
        self.grid.heading("col3", text="Duracion", anchor=CENTER)
        self.grid.heading("col4", text="Nombre director", anchor=CENTER)        
